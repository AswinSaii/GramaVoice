...
$where_conditions = ["i.assigned_to = ?", "u.verified = 1"];
$params = [$admin_id];
$param_types = "i";
...
// Get all citizens who have submitted issues to this admin
$stmt = $db->prepare("
    SELECT DISTINCT u.*, 
...
if (isset($_GET['export']) && $_GET['export'] === 'csv') {
    ...
    fputcsv($output, ['Citizen ID', 'Name', 'Phone', 'Total Issues', 'Resolved Issues', 'Pending Issues', 'In Progress Issues', 'Joined Date']);
    
    foreach ($citizens as $citizen) {
        fputcsv($output, [
            '#' . str_pad($citizen['id'], 4, '0', STR_PAD_LEFT),
            $citizen['name'],
            $citizen['phone'],
            $citizen['total_issues'],
            $citizen['resolved_issues'],
            $citizen['pending_issues'],
            $citizen['in_progress_issues'],
...
<head>
    ...
    <title>Citizens - Grama Voice</title>
...
<body>
                ...
                <div class="header-actions">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="?status=all">All Citizens</a></li>
        ...
        <div class="p-4">
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-3">
                    <div class="stats-card">
                        ...
                        <h3 class="fw-bold mb-1"><?php echo count($citizens); ?></h3>
                ...
                <div class="col-md-3">
                    <div class="stats-card">
                        ...
                        <h3 class="fw-bold mb-1"><?php echo array_sum(array_column($citizens, 'resolved_issues')); ?></h3>
                        <p class="text-muted mb-0">Issues Resolved</p>
                        <small class="text-success">By citizens</small>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="stats-card">
                        ...
                        <h3 class="fw-bold mb-1"><?php echo array_sum(array_column($citizens, 'pending_issues')); ?></h3>
                ...
                <div class="col-md-3">
                    <div class="stats-card">
                        ...
                        <h3 class="fw-bold mb-1">
                            <?php 
                            $total_issues = array_sum(array_column($citizens, 'total_issues'));
                            $resolved_issues = array_sum(array_column($citizens, 'resolved_issues'));
                        ...
                        <small class="text-info">Overall performance</small>
                    </div>
                </div>
            </div>
            ...
            <div class="table-container">
                <div class="table-header">
                    <h5 class="table-title">Citizen Directory</h5>
                    <div class="table-actions">
                        <span class="badge bg-primary"><?php echo count($citizens); ?> Citizens</span>
                    </div>
                </div>
                            ...
                            <?php if (empty($citizens)): ?>
                                <tr>
                                    <td colspan="8" class="text-center py-5">
                                        ...
                                        <p class="text-muted">Citizens will appear here when they submit issues to your panchayat.</p>
                                    </td>
                                </tr>
                            <?php else: ?>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="citizen-avatar">
                                                    <?php echo strtoupper(substr($citizen['name'], 0, 1)); ?>
                                                </div>
                                                <div>
                                                    <div class="fw-bold"><?php echo htmlspecialchars($citizen['name']); ?></div>
                                                    <small class="text-muted">Citizen ID: #<?php echo str_pad($citizen['id'], 4, '0', STR_PAD_LEFT); ?></small>
                                                </div>
                                            </div>
                                        </td>
                                        <td><?php echo htmlspecialchars($citizen['phone']); ?></td>
                                        <td>
                                            <span class="badge bg-primary"><?php echo $citizen['total_issues']; ?></span>
                                        </td>
                                        <td>
                                            <span class="badge badge-success"><?php echo $citizen['resolved_issues']; ?></span>
                                        </td>
                                        <td>
                                            <span class="badge badge-warning"><?php echo $citizen['pending_issues']; ?></span>
                                        </td>
                                        <td>
                                            <span class="badge badge-danger"><?php echo $citizen['in_progress_issues']; ?></span>
                                        </td>
                                        <td><?php echo date('M j, Y', strtotime($citizen['created_at'])); ?></td>
                                        <td>
                                            <button class="btn-outline btn-sm" data-bs-toggle="modal" data-bs-target="#citizenModal<?php echo $citizen['id']; ?>">
    ...
    <!-- Citizen Detail Modals -->
    <?php foreach ($citizens as $citizen): ?>
        <div class="modal fade" id="citizenModal<?php echo $citizen['id']; ?>" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Citizen Profile - <?php echo htmlspecialchars($citizen['name']); ?></h5>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="text-center">
                                    <div class="citizen-avatar mx-auto mb-3" style="width: 80px; height: 80px; font-size: 2rem;">
                                        <?php echo strtoupper(substr($citizen['name'], 0, 1)); ?>
                                    </div>
                                    <h5><?php echo htmlspecialchars($citizen['name']); ?></h5>
                                    <p class="text-muted">Citizen ID: #<?php echo str_pad($citizen['id'], 4, '0', STR_PAD_LEFT); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <span class="text-muted"><?php echo htmlspecialchars($citizen['phone']); ?></span>
                                    </div>
                                    <div class="col-md-6">
                                        <strong><i class="fas fa-calendar me-1"></i>Joined:</strong>
                                        <span class="text-muted"><?php echo formatDate($citizen['created_at']); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="text-center p-3 bg-light rounded">
                                            <h4 class="text-primary mb-1"><?php echo $citizen['total_issues']; ?></h4>
                                            <small class="text-muted">Total Issues</small>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="text-center p-3 bg-light rounded">
                                            <h4 class="text-success mb-1"><?php echo $citizen['resolved_issues']; ?></h4>
                                            <small class="text-muted">Resolved</small>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="text-center p-3 bg-light rounded">
                                            <h4 class="text-warning mb-1"><?php echo $citizen['pending_issues'] + $citizen['in_progress_issues']; ?></h4>
    ...
    <script>
        ...
        function exportToPDF() {
            ...
            printWindow.document.write(`
                <html>
                    <head>
                        <title>Citizens Report - ${new Date().toLocaleDateString()}</title>
                        <style>
                    ...
                    <body>
                        <div class="header">
                            <h1>Grama Voice - Citizens Report</h1>
                            <p>Generated on: ${new Date().toLocaleDateString()}</p>
                        </div>
                        <div class="stats">
                            <div class="stat-item">
                                <div class="stat-value"><?php echo count($citizens); ?></div>
                                <div class="stat-label">Total Citizens</div>
                            </div>
                            <div class="stat-item">
                                <div class="stat-value"><?php echo array_sum(array_column($citizens, 'resolved_issues')); ?></div>
                                <div class="stat-label">Issues Resolved</div>
                            </div>
                            <div class="stat-item">
                                <div class="stat-value"><?php echo array_sum(array_column($citizens, 'pending_issues')); ?></div>
                                <div class="stat-label">Pending Issues</div>
                            </div>
                            <div class="stat-item">
                                <div class="stat-value"><?php echo array_sum(array_column($citizens, 'total_issues')); ?></div>
                        ...
                        <table>
                            ...
                            <tbody>
                                <?php foreach ($citizens as $citizen): ?>
                                <tr>
                                    <td>#<?php echo str_pad($citizen['id'], 4, '0', STR_PAD_LEFT); ?></td>
                                    <td><?php echo htmlspecialchars($citizen['name']); ?></td>
                                    <td><?php echo htmlspecialchars($citizen['phone']); ?></td>
                                    <td><?php echo $citizen['total_issues']; ?></td>
                                    <td><?php echo $citizen['resolved_issues']; ?></td>
                                    <td><?php echo $citizen['pending_issues']; ?></td>
                                    <td><?php echo $citizen['in_progress_issues']; ?></td>
                                    <td><?php echo date('M j, Y', strtotime($citizen['created_at'])); ?></td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
