...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($phone) || empty($password)) {
        ...
        try {
            ...
            $stmt = $db->prepare("SELECT id, name, phone, password, village_name FROM panchayat_admins WHERE phone = ?");
            ...
            if ($result->num_rows > 0) {
                ...
                if (password_verify($password, $admin['password'])) {
                    ...
                    $_SESSION['village_name'] = $admin['village_name'];
...
<head>
    ...
    <title>Admin Login - Grama Voice</title>
    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="auth-header">
                <h2><i class="fas fa-user-tie brand-icon"></i>Grama Voice</h2>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (loginForm) {
                loginForm.addEventListener('submit', function(e) {
                    ...
                    if (!validatePhoneNumber(phone) || !password.trim()) {
                        e.preventDefault();
                        return false;
                    }
