...
$notifications = getUserNotifications($user_id, 100, false); // Get up to 100 notifications
...
<head>
    ...
    <title>All Notifications - Grama Voice</title>
        ...
        <div id="notificationsList">
            <?php if (empty($notifications)): ?>
                <div class="empty-state">
                    ...
                    <a href="submit_issue.php" class="btn btn-primary">
